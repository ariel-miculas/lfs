...
- [Preparing for the build](#preparing-for-the-build)
  - [Creating qemu disk image](#creating-qemu-disk-image)
    - [Use the image file as a loopback device](#use-the-image-file-as-a-loopback-device)
    - [Setup partitions](#setup-partitions)
    - [Setup filesystems](#setup-filesystems)
    - [Mounting partitions](#mounting-partitions)
  - [Preparations](#preparations)
    - [Packages](#packages)
    - [Creating the necessary folders](#creating-the-necessary-folders)
    - [Adding the lfs user](#adding-the-lfs-user)
    - [Setting up the environment (run as user lfs)](#setting-up-the-environment-run-as-user-lfs)
- [LFS cross toolchain](#lfs-cross-toolchain)
  - [binutils](#binutils)
  - [gcc](#gcc)
  - [Linux API headers](#linux-api-headers)
  - [Glibc](#glibc)
  - [Libstdc++](#libstdc)
- [LFS Temporary tools](#lfs-temporary-tools)
  - [M4](#m4)
  - [ncurses](#ncurses)
  - [Bash](#bash)
  - [Coreutils](#coreutils)
  ...
  - [Tar](#tar)
  - [Xz](#xz)
  - [Binutils (pass 2)](#binutils-pass-2)
  - [Gcc (pass 2)](#gcc-pass-2)
- [LFS chroot temporary tools](#lfs-chroot-temporary-tools)
  - [Root commands](#root-commands)
  - [Chroot commands](#chroot-commands)
    - [Enter chroot (execute as root)](#enter-chroot-execute-as-root)
    - [Creating directories/files/symlinks](#creating-directoriesfilessymlinks)
    - [Libstdc++ (pass 2)](#libstdc-pass-2)
    - [Gettext](#gettext)
    - [Bison](#bison)
    - [Perl](#perl)
    ...
    - [Cleanup](#cleanup)
- [Building LFS system](#building-lfs-system)
  - [Man-pages](#man-pages)
  - [Iana-Etc](#iana-etc)
  - [Glibc](#glibc-1)
  - [zlib](#zlib)
  ...
  - [Check](#check)
  - [Diffutils](#diffutils-1)
  - [Gawk](#gawk-1)
  - [Findutils](#findutils-1)
  - [Groff](#groff)
  - [Grub](#grub)
  - [Less](#less)
  - [Gzip](#gzip-1)
...
- [Making the LFS system bootable](#making-the-lfs-system-bootable)
  - [Fstab](#fstab)
  - [Kernel](#kernel)
  - [Kernel modules load order](#kernel-modules-load-order)
  - [Grub](#grub-1)
...
127.0.1.1 lfs.example.org ariel-lfs
192.168.1.1 lfs.example.org ariel-lfs [alias1] [alias2 ...]
